  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#eae6fd] px-4">
      <div className="w-full max-w-md bg-white p-8 rounded-xl shadow-lg">
        <h2 className="text-3xl font-bold text-blue-700 mb-2 text-center">Welcome!</h2>
        <p className="text-sm text-gray-600 mb-6 text-center">Please fill in the details to create an account</p>
